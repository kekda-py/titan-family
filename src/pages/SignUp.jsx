            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-lg mx-auto">
                <form action="https://formsubmit.co/a6d275e1602053e03a59d4a2efe09730" method="POST">
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <label className="block text-gray-800 text-sm font-medium mb-1" htmlFor="password">Message <span className="text-red-600">*</span></label>
                      <textarea id="password" name="message" className="form-input h-32 w-full text-gray-800" placeholder="Enter the message" required />
                    </div>
                  </div>
